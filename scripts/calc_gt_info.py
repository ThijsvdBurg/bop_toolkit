...
# for split in ['01','02','05','11','12','15']:
for split in ['07','17']:
# for split in ['04','06','08']: 
# for split in ['05']:
        ...
        if im_counter % 20 == 0:
          misc.log(
            'Calculating GT info - dataset: {} ({}, {}), scene: {}, im: {}'.format(
              p['dataset'], dp_split['split'], p['dataset_split_type'], scene_id,
              im_id))
        ...
        for gt_id, gt in enumerate(scene_gt[im_id]):
          ...
          if p['vis_visibility_masks']:
            ...
            vis_path = p['vis_mask_visib_tpath'].format(
              delta=p['delta'], dataset=p['dataset'], split=dp_split['split'],
              scene_id=scene_id, im_id=im_id, gt_id=gt_id)
