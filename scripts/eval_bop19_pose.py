...
p = {
  ...
  'result_filenames': [
    # 'zebrapose_husky_experiment_01_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_02_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_05_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_07_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_11_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_12_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_15_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    # 'zebrapose_husky_experiment_17_obj07_exp1_{}_20230609.csv'.format(config.predictor),
    ...
    # 'zebrapose_husky_experiment_01_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_02_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_03_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_04_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_05_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_06_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_07_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_08_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_09_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_11_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_12_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_13_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_14_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    'zebrapose_husky_experiment_15_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_16_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_17_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_18_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
    # 'zebrapose_husky_experiment_19_obj07_exp{}_{}_20230609.csv'.format(config.exp_type, config.predictor),
...
for result_filename in p['result_filenames']:
  ...
  if exp_type == 'exp0':
    ...
    # 'test_targets_bop19_WIP_0{:03d}33.json'.format(seq_encoding),
